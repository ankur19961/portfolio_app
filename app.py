...
def side_page():
    ...
    # Contact rows with theme-aware icons
    st.markdown(
        """
        <div class="contact-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="var(--text-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="L22 6L12 13L2 6" stroke="var(--text-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <div>
    ...
    st.markdown(
        ...
        <div class="contact-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22 16.92V19.92C22 20.52 21.39 21 20.77 21C9.23 21 2 13.77 2 2.23C2 1.61 2.48 1 3.08 1H6.08C6.68 1 7.16 1.45 7.17 2.05C7.17 3.25 7.33 4.42 7.63 5.52C7.78 6.02 7.59 6.56 7.18 6.97L5.89 8.26C7.37 11.18 10.82 14.63 13.74 16.11L15.03 14.82C15.44 14.41 15.98 14.22 16.48 14.37C17.58 14.67 18.75 14.83 19.95 14.83C20.55 14.83 21 15.31 21 15.91L22 16.92Z" stroke="var(--text-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <div>
    ...
    st.markdown(
        ...
        <div class="contact-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21 10C21 17 12 23 12 23S3 17 3 10C3 6.13 6.13 3 10 3H14C17.87 3 21 6.13 21 10Z" stroke="var(--text-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="12" cy="10" r="3" stroke="var(--text-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <div>
    ...
    # Social links with theme-aware SVG icons
    st.markdown(
        """
        <div class="social-icons">
            <a href="https://www.linkedin.com/in/ankurshukla1996/" target="_blank">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="var(--text-primary)" xmlns="http://www.w3.org/2000/svg">
